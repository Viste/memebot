...
@router.message(F.chat.id_in(group_id), F.content_type.in_({'photo'}), F.chat.type.in_({'group', 'supergroup'}))
...
@router.message(F.chat.id_in(group_id), F.chat.type.in_({'group', 'supergroup'}))
